...
unsigned long do_resize_request(int count, int inflation, int *buf, int round);
...
unsigned long do_resize_request(int count, int inflation, int *buf, int round)
{
	...
	return policy_do_resize(cache_global->policy, count, inflation, buf, &ool.locker, cache_global->app_groups);
}

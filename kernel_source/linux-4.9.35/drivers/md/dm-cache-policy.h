...
struct dm_cache_policy {
	...
	/*	unaisp	*/
	dm_cblock_t (*invalid_blocks)(struct dm_cache_policy *p);	
	/*	unaisp	*/
	...
	unsigned long (*do_resize)(struct dm_cache_policy *p, int count, int inflation, int *buf, struct policy_locker *locker, 
		struct app_group_t *app_groups);
	...
	// int (*do_resize)(int count, int inflation, int *buf);

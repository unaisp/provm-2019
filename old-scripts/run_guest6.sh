...
-drive if=virtio,file=/home/unaisp/ssd_sdb1/provm/guest_image/ubuntu16.04-6,cache=none \
...
-drive if=virtio,file=/dev/sdc,format=raw,cache=none,vssd,vm-id=308,vm-name=Virtual-Machine-308,size=200,allocate=200,persist=NONE
#-drive if=virtio,file=/dev/nbd3,format=raw,cache=none \
